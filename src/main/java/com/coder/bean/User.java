...
public class User {
	...
	public User(String business_code, int cust_number, Date clear_date, int buisness_year, String doc_id,
			Date posting_date, Date document_create_date, Date document_create_date1, Date due_in_date,
			String invoice_currency, String document_type, int posting_id, String area_business,
			double total_open_amount, Date baseline_create_date, String cust_payment_terms, int invoice_id, int isOpen,
			String aging_bucket, int is_deleted) {
		super();
	...
	public User(int sl_no, String business_code, int cust_number, Date clear_date, int buisness_year, String doc_id,
			Date posting_date, Date document_create_date, Date document_create_date1, Date due_in_date,
			String invoice_currency, String document_type, int posting_id, String area_business,
			double total_open_amount, Date baseline_create_date, String cust_payment_terms, int invoice_id, int isOpen,
			String aging_bucket, int is_deleted) {
